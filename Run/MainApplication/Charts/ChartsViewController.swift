...
protocol ChartsPresenterToViewProtocol: ActivityIndicatorProtocol {
    func setDataInCharts(dateWeek: String,
                         dataCharts: [BarChartDataEntry],
                         distance: String,
                         time: String,
...
final class ChartsViewController: UIViewController {
    ...
    private lazy var selectPeriod: UISegmentedControl = {
        ...
        segmentControl.setTitleTextAttributes([NSAttributedString.Key.font:
                                                UIFont.systemFont(ofSize: OurFonts.fontPTSansRegular16.pointSize)],
                                              for: .normal)
